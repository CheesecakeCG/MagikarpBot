# Taken from https://github.com/Rapptz/RoboDanny/blob/rewrite/cogs/utils/paginator.py
...
class Pages:
    ...
    def __init__(self, ctx, *, entries, per_page=12, show_entry_count=True):
        ...
        self.embed = discord.Embed(colour=randint(0, 16777215))
...
class HelpPaginator(Pages):
    ...
    async def show_page(self, page, *, first=False):
        ...
        if hasattr(self, '_is_bot'):
            value ='Magikarp bot'
            self.embed.add_field(name='Description', value=value, inline=False)
